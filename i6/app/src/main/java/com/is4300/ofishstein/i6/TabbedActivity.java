...
public class TabbedActivity extends AppCompatActivity {
     ...
     * A placeholder fragment containing a simple view.
     */
    public static class FlowFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
     ...
     * A placeholder fragment containing a simple view.
     */
    public static class BorderFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static BorderFragment newInstance(int sectionNumber) {
            BorderFragment fragment = new BorderFragment();
            Bundle args = new Bundle();
            args.putInt(ARG_SECTION_NUMBER, sectionNumber);
            fragment.setArguments(args);
            return fragment;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_border, container, false);
            return rootView;
        }
    }
